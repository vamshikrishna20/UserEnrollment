package com.healthcare.enrollment.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.healthcare.enrollment.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.healthcare.enrollment.model" });
